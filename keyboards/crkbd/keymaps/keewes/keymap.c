...
enum custom_keycodes {
 ...
 [_LAYER0] = LAYOUT_split_3x5_3(
     KC_LBRC, KC_QUOT,  KC_SCLN, KC_P,  KC_Y,                            KC_X, KC_G,     KC_C,    KC_R,    KC_Z,
     GUI_A,   ALT_O,   SFT_E,  CTL_U, KC_I,                              KC_D, CTL_H,    SHFT_T,  ALT_N,   GUI_S,
     KC_Q,    KC_W,    KC_K,   KC_J,  KC_B,                              KC_M, KC_V,  KC_L,    KC_F,    KC_BSPC,
              KC_ESC, LT(3, KC_DOT), LT(4, KC_COMM),         LT(2, KC_ENT), LT(1, KC_SPC), KC_DEL),

[_LAYER1] = LAYOUT_split_3x5_3(
     XXXXXXX, KC_HOME, KC_UP, KC_END,    XXXXXXX,                                   RCTL(KC_C), RCTL(KC_V), RCTL(KC_X), RCTL(KC_Z), RCTL(KC_Y),
     XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, XXXXXXX,                                   RCTL(KC_S), RCTL(KC_F), RCTL(KC_B), _______,    RSFT(KC_MINS),
     XXXXXXX, KC_PGDN, XXXXXXX, KC_PGUP, XXXXXXX,                                   KC_SLSH,      KC_NUHS,    KC_RBRC,    KC_NUBS,    KC_MINS,
                                KC_TAB, KC_LSFT, KC_LCTL,               _______, _______, _______),
...
[_LAYER2] = LAYOUT_split_3x5_3(
    ...
    LSFT(KC_1), LSFT(KC_2), LSFT(KC_3), LSFT(KC_4), LSFT(KC_5),                               LSFT(KC_6),    LSFT(KC_7), LSFT(KC_8), LSFT(KC_9), LSFT(KC_0),
     _______,    RALT(KC_2), RALT(KC_3), RALT(KC_4), RALT(KC_5),                              RSFT(KC_MINS), RALT(KC_7), RALT(KC_8), RALT(KC_9), RALT(KC_0),
                                                 KC_TAB, KC_LSFT, KC_LCTL,           _______, _______, _______),
...
uint32_t layer_state_set_user(uint32_t state) {
  state = update_tri_layer_state(state, _LAYER1, _LAYER3, _LAYER4);
  return state;
}
